...
CREATE TABLE IF NOT EXISTS `mydb`.`activity` (
  ...
  CONSTRAINT `fk_activity_company1`
    ...
    REFERENCES `mydb`.`company` (`user_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`jobseeker`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`jobseeker` ;

CREATE TABLE IF NOT EXISTS `mydb`.`jobseeker` (
  `user_id` INT NOT NULL,
  PRIMARY KEY (`user_id`),
...
-- -----------------------------------------------------
-- Table `mydb`.`contactRequest`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `mydb`.`contactRequest` ;

CREATE TABLE IF NOT EXISTS `mydb`.`contactRequest` (
